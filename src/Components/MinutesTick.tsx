...
function MinutesTick(props : Props) {

    const minutesToRem = () => {return -(props.minutesData * 4) + 1}

  return (
    <div className="tickContainer" style={{['--trans-value' as any] : `${minutesToRem()}rem`}}>
